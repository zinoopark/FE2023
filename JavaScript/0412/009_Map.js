//Map 객체는 키-값 쌍을 가지는 객체 자료형의 한 종류입니다. 근데 키-값 쌍을 가지는 건 object가 이미 있지 않냐..?
// object에 비해 장점은둘 다 key - value 관계를 가진다는 점에서 비슷해보이지만 몇 가지 중요한 차이점이 있습니다 - Object의 키는 문자열 타입으로만 지정해야하지만, Map의 키는 모든 값을 가질 수 있습니다.
